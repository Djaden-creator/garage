...
<?php
                          ...
                          $full_url=$path.'/'.'assets/profilpicture/'.$username.'/images/'.$filename;
             $sql="UPDATE `users` SET `image`=:full_url where idUser= :getid";
...
<div style="background-color:#d94350;display:flex;justify-content:center; align-items:center;
                                                                      border-radius:5px;padding:10px 20px;">
    <h5 style="color: #f2f2f2;font-size:18px">ooup ressayez</h5>
</div>
<?php
             }
