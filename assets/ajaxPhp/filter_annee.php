...
$username = 'root';
 ...
 try{
    ...
    if(isset($_POST["minannee"]) && isset($_POST["maxannee"])){
        $minannee=$_POST['minannee'];
        $maxannee=$_POST['maxannee'];
$sql="SELECT * FROM item  where annee BETWEEN  $minannee AND $maxannee  ORDER BY idItem DESC";
...
<div style="background-color:#d94350;display:flex;justify-content:center; align-items:center;
    ...
    <h5 style="color: #f2f2f2;font-size:18px">
        nous avons pas des voitures de cette année
    </h5>
</div>
<?php
    }
