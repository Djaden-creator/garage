    ...
    <section class="connect">
        <div class="row">
            <form action="" method="post">
               ...
               $addservice->service();
            ?>
                <h3>ajoutez un service</h3>
                <input type="text" name="service" placeholder="type de service" class="box">
                <textarea name="description" id="" class="box"></textarea>
                <input type="submit" name="addservice" value="send message" class="btn">
            </form>
